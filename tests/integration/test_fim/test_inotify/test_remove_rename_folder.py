...
from wazuh_testing.fim import (LOG_FILE_PATH, callback_delete_watch, callback_num_inotify_watches, regular_file_cud,
                               generate_params, detect_initial_scan, detect_initial_scan)
...
def test_readded_watches(removed, renamed, get_configuration, configure_environment, restart_syscheckd_each_time):
    ...
    file = wazuh_log_monitor.start(timeout=global_parameters.default_timeout, callback=callback_delete_watch,
